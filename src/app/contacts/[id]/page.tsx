  ...
  const fetchInitialData = useCallback(async () => {
    ...
    try {
      ...
      if (leadDoc.exists()) {
        ...
        const totalPrice = (leadData.commitmentSnapshot?.deals || []).reduce((sum, deal) => sum + deal.price, 0);
        setCurrentPayPlan(leadData.paymentPlan || { totalPrice: totalPrice, installments: [] });
